...
namespace Isotope_fitting
{
    ...
    public static class SutherlandHodgman
    {
        ...
        public static double GetIntersectedPolygon_area(Point[] subjectPoly, Point[] clipPoly)
        {
            ...
            return SignedPolygonArea(outputList);
        ...
        private static double SignedPolygonArea(List<Point> polygon)
        {
