...
{
    public partial class Format_primary_plot : Form
    {
        Form2 frm2;
        public Format_primary_plot(Form2 f,int tab)
        {
            InitializeComponent();
            frm2 = f;
        ...
        private void Format_primary_plot_DpiChanged(object sender, DpiChangedEventArgs e)
        {
