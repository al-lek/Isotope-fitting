...
namespace ClipperLib
{
    ...
    public class Clipper
    {
        ...
        private static double TopX(Active edge, double currentY)
        {
        ...
        internal double GetTopDeltaX(Active e1, Active e2)
        {
        ...
        private void InsertNewIntersectNode(Active e1, Active e2, double topY)
        {
        ...
        private bool ResetHorzDirection(Active horz, Active maxPair,
          out double horzLeft, out double horzRight)
        {
